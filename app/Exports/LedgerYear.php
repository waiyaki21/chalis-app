...
class LedgerYear implements FromView, WithEvents, WithColumnWidths, WithStyles, WithProperties, ShouldAutoSize, WithColumnFormatting
{
    ...
    public function yearInfo($year)
    {
        ...
        // get year cycles no 
        $cycles         = DB::table('cycles')->where('year', $year)->get();
        $count          = DB::table('cycles')->where('year', $year)->count();
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // get all cycles 
        $cycles    = $this->yearInfo($this->year);
    ...
    public function properties(): array
    {
        return [
            ...
            'title'          => $this->year .' Contributions & Welfares Ledger',
