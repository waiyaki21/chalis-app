...
class CyclesExportAll implements FromView, WithEvents, WithColumnWidths, WithStyles, WithProperties, ShouldAutoSize, WithColumnFormatting
{
    private $cycle;
    ...
    {
        $all       = DB::table('members')->where('deleted_at', null)->get();
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // get members & count 
        $info      = DB::table('members')->where('deleted_at', null)->get();
