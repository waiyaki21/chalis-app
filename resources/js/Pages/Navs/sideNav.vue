                ...
                <li class="relative"
                    ...
                    <span :class="props.done ? info.spanClass1 : info.settingsClass1">
                        <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            :class="[info.svgSize]">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M22 10.5h-7m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM4 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 10.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
                        </svg>
                    </span>
...
<script setup>
    ...
    const info = reactive ({
        ...
        settingsClass1      : 'mr-1 [&>svg]:h-7 [&>svg]:w-7 [&>svg]:text-red-800 dark:[&>svg]:text-red-300 dark:hover:[&>svg]:text-red-600',
        ...
        svg3: '<svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-1 [&>svg]:h-7 [&>svg]:w-8 [&>svg]:text-gray-800 dark:[&>svg]:text-gray-300 dark:hover:[&>svg]:text-cyan-600  transition duration-75 h-7 w-7"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>',
