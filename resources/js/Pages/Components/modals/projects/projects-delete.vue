        ...
        <section class="p-2 font-boldened">
            ...
            <section class="flex w-full justify-start my-1">
                <h3
                    ...
                    Are you sure you want to delete this project : {{ info.name }}?
                </h3>
            </section>
            ...
            <section class="flex w-full justify-start my-1">
                <h3
                    class="font-normal text-2xl text-red-800 dark:text-red-600 leading-tight uppercase underline py-1 w-full decoration-red-900">
                    Are you sure you want to delete {{ classInfo.deleteData.name }}? Deleting a Project will in turn delete
                    the project expense records held within!
                </h3>
            </section>
...
<script setup>
    ...
    function deleteInfo() {
        ...
        router.delete(url, {
            ...
            onSuccess: () => [
                // flashMessage 
                alerts.flashMessage   = 'Project '+ name +' Deleted!',
