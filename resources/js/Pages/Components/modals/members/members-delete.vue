    ...
    <Modal :show=classInfo.isDeleteOpen>
        <section class="p-2 font-boldened">
            ...
            <section class="flex w-full justify-start my-1">
                <h3 class="font-normal sm:text-base md:text-lg text-red-800 dark:text-red-600 leading-tight uppercase underline py-1 w-full decoration-red-900">
    ...
    function deleteInfo() {
        ...
        router.delete(url, {
            ...
            onSuccess: () => [
                ...
                // flashMessage 
                alerts.flashMessage   = name + ': Member Deleted!',
