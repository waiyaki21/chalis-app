<template>
    ...
    <section class="w-full justify-between grid grid-cols-1 md:grid-cols-5">
        ...
        <div class="py-2 pr-1 col-span-4 flex-row justify-between space-x-2">
            <!-- member tabs  -->
            <div class="text-sm font-boldened text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 w-full mb-2 mx-2 p-1 inline-flex justify-between uppercase">
                <ul class="flex flex-wrap -mb-px">
                    <li class="me-2">
                        <a :class="[classInfo.tab1]" @click="tabSwitch()">
                            {{ classInfo.tab1Name }}
                            <span class="bg-blue-100 text-gray-800 md:text-sm font-normal mx-1 px-1.5 py-0.5 rounded-full dark:bg-cyan-900 dark:text-white border-2 border-cyan-900 dark:border-cyan-500">
                    ...
                    <li class="me-2">
                        <a :class="[classInfo.tab3]" @click="tabSwitch3()">
                            {{ classInfo.tab3Name }}
                            <span class="bg-blue-100 text-gray-800 text-sm font-normal mx-1 px-1.5 py-0.5 rounded-full dark:bg-cyan-900 dark:text-white border-2 border-cyan-900 dark:border-cyan-500">
            ...
            <div :class="['overflow-hidden rounded-lg md:rounded-md w-full p-1']" v-if="classInfo.tab1show">
                ...
                <section :class="[classInfo.infoSection]"> 
                    <section :class="['w-full justify-between m-1 p-1 text-left space-x font-boldened grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-1']">
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5 :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Total no of payments">
                            ...
                            <p class="font-normal text-left md:text-3xl text-2xl text-blue-700 dark:text-blue-400 uppercase">
                        ...
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5
                                :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Total amount contributed before entering system data">
                                <span>Amount Before</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-green-700 dark:text-green-400 uppercase" :title="'ksh ' + Number(member.amount_before).toLocaleString()">
                        ...
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5
                                :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Total amount contributed in all cycles">
                                <span>T. Contributed</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-green-700 dark:text-green-400 uppercase" :title="'ksh ' + Number(member.payments_sum).toLocaleString()">
                                <!-- ksh {{ numFormat(paySum) }} -->
                        ...
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5
                                :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Grand Total of all contributions in all cycles">
                                <span>Grand Total</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-green-700 dark:text-green-400 uppercase" :title="'ksh ' + Number(member.payments_total).toLocaleString()">
                ...
                <div :class="['bg-gray-300 dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg md:rounded-md w-full p-2', classInfo.borderClass]">
                    ...
                    <div class="py-2 relative overflow-x-auto">
                        <h2 class="font-normal font-boldened text-[3rem] text-center text-cyan-800 dark:text-cyan-300 leading-tight uppercase underline py-1" v-if="allPayments.length == 0">
                            ADD MEMBER PAYMENTS!!
                        </h2>
                        ...
                        <section class="overflow-y-scroll h-auto max-h-[35rem]" v-else>
                            <table class="mx-auto w-full text-base text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-gray-700 uppercase bg-transparent dark:text-gray-300 font-boldened text-base">
                                    <tr>
                                        ...
                                        <td scope="col" class="px-2 uppercase hover:underline dark:text-gray-400 dark:hover:text-white cursor-pointer" @click="orderByPayments()">
                                            <div class="flex items-center">
                                                Total Paid.
                                                <a>
                                                    <svg class="w-3 h-3 ml-1.5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <td scope="col" class="px-2 uppercase hover:underline dark:text-gray-400 dark:hover:text-white cursor-pointer" @click="orderByCycle()">
                                            <div class="flex items-center">
                                                Payment Cycle.
                                                <a>
                                                    <svg class="w-3 h-3 ml-1.5" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 font-boldened text-base uppercase"
                                        ...
                                        <td class="px-2 py-4">
                                            <a @click="getRoute(payment.cycle_id)" class="text-white bg-gradient-to-r from-cyan-600 to-blue-700 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg p-2 text-center me-2 mb-2 flex w-full justify-between cursor-pointer">
            ...
            <section class="w-full overflow-hidden font-boldened flex-row" v-if="classInfo.tab2show">
                <h3 class="font-boldened p-2">
                    <span :class="[classInfo.mainHeader, 'justify-between w-full mb-1 grid grid-cols-2 md:grid-cols-5 gap-1']">
...
<!-- 
                    ...
                    <!-- end upload sheet  -->
                    <!-- forms  -->
                    <div :class="['p-2 col-span-4 rounded-lg bg-gray-300 dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg h-fit', classInfo.borderClass]">
                        <!-- <h3 :class="[classInfo.mainHeader,'underline']">
                        ...
                        <form @submit.prevent="verify" class="p-2">
                            <section class="w-full grid grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <select id="member_id" v-model="form.member_id" name="member_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div>
                                    ...
                                    <select id="cycle_id" v-model="form.cycle_id" name="cycle_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" :placeholder="cycle.name">
                                        <option v-for="cycle in props.cycles" :value="cycle.id" @click="checkPayments(cycle)">
                                            {{ cycle.name }}
                                        </option>
                                    </select>
                            ...
                            <section class="w-full grid grid-cols-1 gap-2">
                                <div>
                                    ...
                                    <span class="text-yellow-300 my-2 py-2 uppercase underline font-boldened font-normal">
                                        Enter <b>0</b> to represent no information
                                    </span>

                                    <TextInput id="payment" type="number" v-model="form.payment" autofocus v-if="classInfo.paysNo == 0"/>

                                    <TextInput id="payment" type="number" v-model="form.payment" class="cursor-not-allowed" disabled v-else/>

                                    <InputError class="mt-2" :message="form.errors.payment" v-if="classInfo.paysNo == 0"/>

                                    <InputError class="mt-2" :message="'The member already has a payment in this cycle'" v-else/>
                                </div>
                            </section>
                            ...
                            <div class="flex items-center justify-start mt-4">
                                <button class="text-white bg-gradient-to-br from-cyan-600 to-green-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-green-800 font-medium rounded-lg text-base px-4 py-2.5 text-center mr-2 mb-2 uppercase inline-flex justify-between w-full" @click="submit">
                                    Submit {{ classInfo.memberInfo.name }} Info
                                    <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6" v-if = "!form.processing">
            ...
            <div :class="['overflow-hidden rounded-lg md:rounded-md w-full p-1']" v-if="classInfo.tab3show">
                ...
                <section :class="[classInfo.infoSection, 'mb-2']"> 
                    <section :class="['w-full justify-between m-1 p-1 text-left space-x font-boldened grid grid-cols-2 md:grid-cols-4 gap-1']">
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5
                                :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Total Welfare amount contributed before entering system data">
                                <span>Amount Before</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-yellow-600 dark:text-yellow-300 uppercase" :title="'ksh ' + Number(member.welfare_before).toLocaleString()">
                                <!-- ksh {{ numFormat(paySum) }} -->
                        ...
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5
                                :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Total Welfares amount contributed in all cycles">
                                <span>T.Welfares In</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-green-700 dark:text-green-400 uppercase" :title="'ksh ' + Number(member.welfare_in).toLocaleString()">
                                <!-- ksh {{ numFormat(paySum) }} -->
                        ...
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5
                                :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Total Welfare amount given out to the member">
                                <span>T.Welfares Out</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-red-700 dark:text-red-700 uppercase" :title="'ksh ' + Number(member.welfare_out).toLocaleString()">
                                <!-- ksh {{ numFormat(paySum) }} -->
                        ...
                        <a class="block max-w-sm p-2 bg-transparent">
                            <h5 :class="[classInfo.infoHeader, 'md:text-[1.1rem] text-2xl']"  title="Grand Total of all welfare payments in all cycles">
                                <span>Grand Total</span>
                                <svg class="flex-shrink-0 inline w-5 h-5 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                </svg>
                            </h5>
                            <p class="font-normal text-left md:text-3xl text-2xl text-blue-700 dark:text-blue-800 uppercase" :title="'ksh ' + Number(member.welfare_total).toLocaleString()">
                ...
                <div :class="['bg-gray-300 dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg w-full p-2', classInfo.borderClass]">
                    <h3 :class="[classInfo.mainHeader,'inline-flex justify-between w-full mb-1']">
                        ...
                        <!-- forms  -->
                        <a @click="tabSwitch2()" type="button" class="text-white bg-gradient-to-br from-teal-500 to-blue-700 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2 uppercase shadow-md cursor-pointer inline-flex justify-between">
                            <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <!-- welfares table  -->
                    <div class="py-2 relative overflow-x-auto">
                        <h2 class="font-normal font-boldened text-[3rem] text-center text-cyan-800 dark:text-cyan-300 leading-tight uppercase underline py-1" v-if="classInfo.welfaresInfo.length == 0">
                            ...
                            <table class="mx-auto w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 font-boldened text-base uppercase"
                                        ...
                                        <td scope="row"
                                            class="px-2 py-4">
                                            <span class="uppercase text-gray-900 whitespace-nowrap dark:text-emerald-500 text-base" v-if="welfare.type == 1">
                                                {{ index + 1 }}.
                                            </span>
                                            <span class="uppercase text-gray-900 whitespace-nowrap dark:text-rose-500 text-base" v-else>
                                                {{ index + 1 }}.
                                            </span>
                                        </td>
                                        <td class="px-2 py-4">
                                            <div class="px-1 text-blue-600 text-xl md:text-2xl" v-if="welfare.type == 1">
                                        ...
                                        <td class="px-2 py-4">
                                            <a @click="getRoute(welfare.cycle_id)" class="text-white bg-gradient-to-r from-cyan-600 to-blue-700 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg p-2 text-center me-2 mb-2 flex w-full justify-center" v-if="welfare.type == 1">
                                                <span class="md:text-xl sm:text-lg">
                                                    {{ welfare.cycle.name }}
                                                </span>
                                            </a>
                                            <a @click="getRoute(welfare.cycle_id)" class="text-white bg-gradient-to-r from-red-600 to-amber-700 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg p-2 text-center me-2 mb-2 flex w-full justify-center" v-else>
                                                <span class="md:text-xl sm:text-lg">
                                                    {{ welfare.cycle.name }}
                                                </span>
                                            </a>
    ...
    <welfaresupdate
        :info   = classInfo.modalData
        :show   = classInfo.isWelfareOpen
        :name   = props.member.name
        :payment= numFormat(classInfo.modalData.payment)
        @reload = reloadWelfares
        @close  = closeWelfare
    ></welfaresupdate>
    ...
    <welfaresdelete
        :info   = classInfo.deleteData
        :show   = classInfo.isDeleteWelfareOpen
        :name   = props.member.name
        :payment= numFormat(classInfo.deleteData.payment)
        @reload = reloadWelfares
        @close  = closeWelfareDelete
    ></welfaresdelete>
    <!-- end delete payment modal  -->
...
<script setup>
        ...
        if (form.cycle_id == '') {
            ...
            if (form.payment == 0 && form.welfare == 0) {
                if (confirm("The payment & welfare value are both 0 ,There is no information to be submitted, proceed?") == true) {
                    classInfo.flashMessage = 'No Payment or Welfare to Submit both were 0!';
                ...
                if (form.payment == 0) {
                    if (confirm("Do you want to enter the welfare of ksh " + welfare +" only, The payment has a value of 0, proceed?") == true) {
                        classInfo.flashMessage = 'Success!, New Welfare of ksh ' + welfare + ' entered!';
                        classInfo.alertType    = 'warning';
                        submit();
                    }   
                } 
                if (form.welfare == 0) {
                    if (confirm("Do you want to enter the payment of ksh " + payment + " only, The welfare has a value of 0, proceed?") == true) {
                        classInfo.flashMessage = 'Success!, New Payment of ksh ' + payment + ' entered!';
                        classInfo.alertType    = 'warning';
                        submit();
                    }   
                }
            ...
            if (form.payment != 0 && form.welfare != 0) {
                classInfo.flashMessage   = 'New payment :ksh' + amount + ' & Welfare :ksh ' + welfare + ' Added!',
        ...
        axios.get('/api/getPays/member/'+ props.member.id +'/'+ cycle.id)
            .then(
                ({ data }) => {
                    ...
                    if (data == 0) {
                        classInfo.flashMessage = props.member.name + 'has (ZERO)' + data + ' payments in ' + cycle.name + '!';
                        classInfo.alertBody = classInfo.alertSuccess;    
                    } else {
                        classInfo.flashMessage = props.member.name + 'already has ' + data + ' payments in ' + cycle.name + '!';
                        classInfo.alertBody = classInfo.alertInfo;
                    }
    ...
    function cycleFull() {
        classInfo.flashMessage = 'The Member already has ( ' + classInfo.paysNo + ' ) or more payment(s) for this cycle!';
        classInfo.alertType    = 'danger';
        flashShow(classInfo.flashMessage, classInfo.alertType);
    }
